package teka.android.organiks_platform_android.presentation.feature_auth.core.data.repository

import kotlinx.coroutines.flow.first
import retrofit2.HttpException
import teka.android.organiks_platform_android.presentation.feature_auth.core.data.dto.UserResponseDto
import teka.android.organiks_platform_android.presentation.feature_auth.core.data.local.AuthPreferences
import teka.android.organiks_platform_android.presentation.feature_auth.core.data.remote.AuthApiService
...
class LoginRepositoryImpl(
    ...
    override suspend fun login(
        loginRequest: LoginRequest, rememberMe: Boolean
    ): ResultResource<Unit> {

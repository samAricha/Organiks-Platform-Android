...
//        if (farmList.isEmpty() && !isFetchingGateLogs) {
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                Column(
                    ...
                    Image(
                        ...
                        contentDescription = "No Sales records illustration",
        ...
        ExtendedFloatingActionButton(
            modifier = Modifier
                ...
                .padding(16.dp),
            onClick = {
                Timber.tag("Sales").i("EFAB clicked")
                navController.navigate(AppScreens.AddCustomerForm.route)
            },
            icon = { Icon(Icons.Filled.Add, contentDescription = "Add Sales") },
            text = { Text(text = "Add Sales") },
        )
    }
}
...
private const val MyFarm_VM_TAG = "MyFarm_VM_TAG"


@HiltViewModel
class MyFarmsListViewModel @Inject constructor(
    ...
    init {
        Timber.Forest.tag(MyFarm_VM_TAG).i("init function now")
        observeCustomerList()
    }
    ...
    fun onDateRangeSelected(selectedRange: Pair<Long?, Long?>) {
        Timber.Forest.tag(MyFarm_VM_TAG).i("selectedDateRange:: $selectedRange")

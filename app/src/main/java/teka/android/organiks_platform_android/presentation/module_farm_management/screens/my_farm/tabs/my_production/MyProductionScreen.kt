package teka.android.organiks_platform_android.presentation.module_farm_management.screens.my_farm.tabs.my_production
...
//        if (farmList.isEmpty() && !isFetchingGateLogs) {
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                Column(
                    ...
                    Image(
                        ...
                        contentDescription = "No records illustration",
                        modifier = Modifier.size(120.dp),
                        alpha = 0.3f
                    )
                    Spacer(modifier = Modifier.height(8.dp))
                    Text(
                        text = "No Production record yet ...",
        ...
        ExtendedFloatingActionButton(
            modifier = Modifier
                ...
                .padding(16.dp),
            onClick = {
                Timber.tag("Produce").i("EFAB clicked")
                navController.navigate(AppScreens.AddCustomerForm.route)

            },
            icon = { Icon(Icons.Filled.Add, contentDescription = "Add Produce") },
            text = { Text(text = "Add Produce") },
        )
    }
}
        ...
        Column(modifier = Modifier.fillMaxWidth().padding(4.dp)) {
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Column(
                    ...
                    LabelValueTextWidget(label = "Phone: ", value = invoiceEntity.toPhone ?: "N/A")
                    LabelValueTextWidget(label = "Amount: ", value = invoiceEntity.totalAmount ?: "N/A")
                    LabelValueTextWidget(label = "Expenses: ", value = invoiceEntity.totalExpenses ?: "N/A")
                    LabelValueTextWidget(
                        label = "Total: ",
                        value = formatCash((invoiceEntity.totalAmount.toDouble() + invoiceEntity.totalExpenses.toDouble()).toString()) ?: "N/A"
                    )
                }
            }

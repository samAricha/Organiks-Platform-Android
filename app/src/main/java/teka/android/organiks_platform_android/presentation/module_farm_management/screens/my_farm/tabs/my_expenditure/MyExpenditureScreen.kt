    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        ExtendedFloatingActionButton(
            modifier = Modifier
                ...
                .padding(16.dp),
            onClick = {
                Timber.tag("Expenditure").i("EFAB clicked")
                navController.navigate(AppScreens.ExpenditureForm.route)

            },
            icon = { Icon(Icons.Filled.Add, contentDescription = "Add Expenditure") },
            text = { Text(text = "Add Expenditure") },
        )
    }
}